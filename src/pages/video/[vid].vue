  ...
  <div class="mx-auto px-4 py-4 lg:px-6">
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1fr)_20rem] xl:grid-cols-[minmax(0,1fr)_22rem]">
      <main class="min-w-0 space-y-2">
        <section class="border border-gray-200 rounded-2xl bg-white p-4 shadow-sm space-y-4 dark:border-gray-700 dark:bg-dark-200 lg:p-6">
          ...
          <div class="space-y-3">
            ...
            <div class="flex flex-wrap gap-2">
              ...
              <!-- <span class="inline-block rounded-full bg-blue-100 px-3 py-1 text-sm text-blue-800 dark:bg-blue-900 dark:text-blue-200">
                {{ result?.getVideo?.item?.site }}
              </span>
              <span class="inline-block rounded-full bg-purple-100 px-3 py-1 text-sm text-purple-800 dark:bg-purple-900 dark:text-purple-200">
                {{ result?.getVideo?.item?.repostType }}
              </span> -->
            </div>
        ...
        <!-- 视频简介 -->
        <section class="border border-gray-200 rounded-2xl bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-dark-200 lg:p-6">
